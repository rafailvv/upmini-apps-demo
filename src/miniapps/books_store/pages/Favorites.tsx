...
export const Favorites: React.FC = () => {
  ...
  // Создаем объект для быстрой проверки книг в корзине
      ...
      <div className="menu-content">
        {favoriteItems.length > 0 ? (
              ...
              {favoriteItems.map((item: MenuItem) => (
                <div key={item.id} className="menu-item-card" onClick={() => handleItemClick(item.id)}>
                  ...
                  <div className="item-info">
                    ...
                    <div className="item-weight">Переплет: {item.size}</div>
          ...
          <div className="empty-cart">
            ...
            <p>Добавьте книги в избранное, чтобы они появились здесь</p>
            <button 
              className="back-to-menu-btn"
              onClick={() => navigate('/miniapp/books_store')}
            >
              Перейти к каталогу
            </button>
          </div>
