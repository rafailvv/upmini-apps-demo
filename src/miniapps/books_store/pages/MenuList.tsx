...
export const MenuList: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        console.log('=== BOOKS_STORE DEBUG ===');
        console.log('Загруженные категории:', categoriesData);
        console.log('Загруженные книги:', menuItemsData);
        console.log('Первые 3 книги:', menuItemsData.slice(0, 3));
        console.log('Источник данных:', 'books_store/utils/dataLoader');
        console.log('==========================');
  ...
  const handleItemClick = (itemId: number) => {
    navigate(`/miniapp/books_store/item/${itemId}`);
  };
  ...
  // Функция для расчета цены книги с добавками
  ...
  console.log('menuItems[0]:', menuItems[0]);
  console.log('menuItems[0].category:', menuItems[0]?.category);
  console.log('menuItems[0].name:', menuItems[0]?.name);
  console.log('========================');
    ...
    <div className="menu-app" ref={containerRef} style={{ height: '100vh', overflowY: 'auto' }}>
      ...
      <div className="menu-header">
        ...
        <div className="header-right">
          <button
            className="cart-icon"
            onClick={() => navigate('/miniapp/books_store/cart')}
          >
            🛒
            {getTotalItems() > 0 && (
                  ...
                  {items.map((item) => (
                    <div key={item.id} className="menu-item-card" onClick={() => handleItemClick(item.id)}>
                      ...
                      <div className="item-info">
                        ...
                        <p className="item-weight">Переплет: {item.size}</p>
      ...
      {getTotalItems() > 0 && (
        <div className="floating-order-btn" onClick={() => navigate('/miniapp/books_store/cart')}>
