            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasWeight ? 'none' : 'line-through'
                }}>вес</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasWeight ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasWeight ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasWaist ? 'none' : 'line-through'
                }}>талия</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasWaist ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasWaist ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasChest ? 'none' : 'line-through'
                }}>грудь</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasChest ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasChest ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasHips ? 'none' : 'line-through'
                }}>бёдра</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                    ...
                    onChange={(e) => {
                      const value = e.target.value.replace(/[^0-9.]/g, '');
                      handleInputChange('hips', parseInt(value) || 0);
                    }}
                    style={{
                      border: 'none',
                      background: 'transparent',
                  ...
                  <button
                    onClick={() => handleInputChange('hasHips', !userData.hasHips)}
                    style={{
                      background: userData.hasHips ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasHips ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasBiceps ? 'none' : 'line-through'
                }}>бицепс</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                    ...
                    onChange={(e) => {
                      const value = e.target.value.replace(/[^0-9.]/g, '');
                      handleInputChange('biceps', parseInt(value) || 0);
                    }}
                    style={{
                      border: 'none',
                      background: 'transparent',
                  ...
                  <button
                    onClick={() => handleInputChange('hasBiceps', !userData.hasBiceps)}
                    style={{
                      background: userData.hasBiceps ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasBiceps ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasThigh ? 'none' : 'line-through'
                }}>бедро</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasThigh ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasThigh ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasBodyFat ? 'none' : 'line-through'
                }}>% жира</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasBodyFat ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasBodyFat ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
                  ...
                  {userData.beforePhoto ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: '14px', fontWeight: '500', color: '#1F2937' }}>
                        {userData.beforePhotoFile ? 'загружено' : 'загружено'}
                      </span>
                      {userData.beforePhotoFile && (
                        <button
                          onClick={() => setViewingPhoto({ data: userData.beforePhotoFile!, name: 'Фото "до"' })}
                          style={{
                            background: '#1E40AF',
                            border: 'none',
                            borderRadius: '3px',
              ...
              {/* Кнопка добавления промежуточного результата */}
              <div style={{ marginBottom: '16px' }}>
                <button
                  onClick={() => {
                    setShowIntermediateForm(true);
              ...
              {userData.intermediateResults.length > 0 && (
                <div style={{ marginBottom: '16px' }}>
                  ...
                  {userData.intermediateResults.map((result, index) => (
                    <div key={result.id} style={{
                          ...
                          <button
                            onClick={() => {
                              ...
                              setIntermediateFormData({
                                ...
                                waist: result.waist?.toString() || '',
                                chest: result.chest?.toString() || '',
                                hips: result.hips?.toString() || '',
                                biceps: result.biceps?.toString() || '',
                                thigh: result.thigh?.toString() || '',
                                bodyFat: result.bodyFat?.toString() || '',
                                squats: result.squats?.toString() || '',
                                pullUps: result.pullUps?.toString() || '',
                                running: result.running?.toString() || '',
                                pulse: result.pulse?.toString() || '',
                                photoFile: null,
                                photoFileName: result.photoFile ? 'Фото' : ''
                              });
                              setShowIntermediateForm(true);
                            }}
                            style={{
                          ...
                          <button
                            onClick={() => {
                              setUserData(prev => {
                                const newData = {
                                  ...prev,
                                  intermediateResults: prev.intermediateResults.filter(r => r.id !== result.id)
                                };
                                localStorage.setItem('userData', JSON.stringify(newData));
                                return newData;
                              });
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Вес: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.weight ? `${result.weight} кг` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Талия: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.waist ? `${result.waist} см` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Грудь: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.chest ? `${result.chest} см` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Бёдра: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.hips ? `${result.hips} см` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Бицепс: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.biceps ? `${result.biceps} см` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Бедро: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.thigh ? `${result.thigh} см` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          % жира: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.bodyFat ? `${result.bodyFat}%` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Приседания: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.squats ? `${result.squats} раз` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Подтягивания: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.pullUps ? `${result.pullUps} раз` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Бег: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.running ? `${result.running} км` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Пульс: <span style={{ color: '#1F2937', fontWeight: '500' }}>{result.pulse ? `${result.pulse} уд/мин` : '—'}</span>
                        </div>
                        <div style={{ fontSize: '13px', color: '#6B7280' }}>
                          Фото: <span style={{ color: '#1F2937', fontWeight: '500' }}>
                                                         {result.photoFile ? (
                               <button
                                 onClick={() => setViewingPhoto({ data: result.photoFile!, name: `Фото от ${result.date}` })}
                                style={{
                                  background: 'none',
                                  border: 'none',
                                  color: '#1E40AF',
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasSquats ? 'none' : 'line-through'
                }}>приседания</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasSquats ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasSquats ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasPullUps ? 'none' : 'line-through'
                }}>подтягивания</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasPullUps ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasPullUps ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasRunning ? 'none' : 'line-through'
                }}>бег</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasRunning ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasRunning ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
              ...
              <div style={{ 
                ...
                <span style={{ 
                  fontSize: '15px', 
                  color: '#6B7280',
                  textDecoration: userData.hasPulse ? 'none' : 'line-through'
                }}>пульс</span>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    style={{
                      background: userData.hasPulse ? '#E5E7EB' : '#1E40AF',
                      border: 'none',
                      borderRadius: '3px',
                      padding: '3px 6px',
                      fontSize: '12px',
                      color: userData.hasPulse ? '#6B7280' : 'white',
                      cursor: 'pointer'
                    }}
                  >
                    нет замера
