...
export const MenuList: React.FC = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        console.log('=== CLOTHING_STORE DEBUG ===');
        console.log('Загруженные категории:', categoriesData);
        console.log('Загруженные товары:', menuItemsData);
        console.log('Первые 3 товара:', menuItemsData.slice(0, 3));
        console.log('Источник данных:', 'clothing_store/utils/dataLoader');
        console.log('==========================');
  ...
  const handleItemClick = (itemId: number) => {
    navigate(`/miniapp/clothing_store/item/${itemId}`);
  };
    ...
    <div className="menu-app" ref={containerRef} style={{ height: '100vh', overflowY: 'auto' }}>
      ...
      <div className="menu-header">
        ...
        <div className="header-right">
          <button
            className="cart-icon"
            onClick={() => navigate('/miniapp/clothing_store/cart')}
          >
            🛒
            {getTotalItems() > 0 && (
                  ...
                  {items.map((item) => (
                    <div key={item.id} className="menu-item-card" onClick={() => handleItemClick(item.id)}>
                      ...
                      <div className="item-info">
                        ...
                        <p className="item-weight">Размер: {item.size}</p>
      ...
      {getTotalItems() > 0 && (
        <div className="floating-order-btn" onClick={() => navigate('/miniapp/clothing_store/cart')}>
