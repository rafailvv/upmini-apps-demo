...
export const ItemDetail: React.FC<ItemDetailProps> = ({ item }) => {
  ...
  const handleGoToCart = () => {
    navigate('/miniapp/clothing_store/cart');
  };

  const handleBackToMenu = () => {
    navigate('/miniapp/clothing_store');
  };
    ...
    <div className="item-detail-page">
      ...
      <div className="item-info-detail">
        ...
        <div className="item-meta-row">
          <p className="item-weight-detail">Размер: {item.size}</p>
        ...
        <div className="recommended-list">
          {recommendedItems.map((recItem) => (
            <div 
              ...
              onClick={() => {
                navigate(`/miniapp/clothing_store/item/${recItem.id}`);
            ...
            >
              ...
              <div className="rec-item-info">
                ...
                <p className="rec-item-volume">Размер: {recItem.size}</p>
